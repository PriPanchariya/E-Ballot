      ...
      >
        ...
        <div>
          <ul className="sidebar-list">
            <li onClick={() => navigate("/addcandidate")}>Dashboard</li>
            <li onClick={() => navigate("/createelection")}>
              Create Election
            </li>
            <li onClick={() => navigate("/electiondetails")}>
              Election Details
            </li>
            <li onClick={() => navigate("/addcandidate")}>
              Add Candidate
            </li>
            <li onClick={() => navigate("/candidatedetails")}>
              Candidate Details
            </li>
